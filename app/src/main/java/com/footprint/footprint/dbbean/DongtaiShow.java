...
public class DongtaiShow {
    ...
    @Generated(hash = 133237765)
    public DongtaiShow(Long id, String name, String title, String code,
            String time, String beizhu1, String beizhu2, String beizhu3,
            String beizhu4, String startAdress, String endAdress) {
        this.id = id;
        this.name = name;
        this.title = title;
        this.code = code;
